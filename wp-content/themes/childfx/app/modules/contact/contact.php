...
if( is_admin() && $calibrefx::is_module_active( 'contact' ) ){
    $calibrefx->hooks->add( 'admin_init', 'contact_load_admin_scripts' );
    $calibrefx->hooks->add( 'calibrefx_theme_settings_meta_section', 'contact_meta_sections' );
    $calibrefx->hooks->add( 'calibrefx_theme_settings_meta_box', 'contact_meta_boxes' );
}
...
function contact_settings(){
    ...
    $calibrefx->hooks->add( 'personal-info-settings_options', function() {            
    ...
    $calibrefx->hooks->add( 'company-info-settings_options', function() {            
        calibrefx_add_meta_option(
...
function map_settings(){
    ...
    $calibrefx->hooks->add( 'map-embed-settings_options', function() {            
        calibrefx_add_meta_option(
    ...
    $calibrefx->hooks->add( 'map-embed-advanced-settings_options', function() {            
        calibrefx_add_meta_option(
    ...
    $calibrefx->hooks->add( 'map-embed-advanced-detail-settings_options', function() {            
        calibrefx_add_meta_option(
