...
if( $calibrefx::is_module_active( 'custom-design' ) ){
    ...
    $calibrefx->hooks->add( 'init', 'custom_design_setup', 0 );
}
...
if( is_admin() && $calibrefx::is_module_active( 'custom-design' ) ){
    $calibrefx->hooks->add( 'calibrefx_theme_settings_meta_box', 'custom_design_meta_boxes' );
}
...
function custom_design_setup(){
    ...
    $calibrefx->hooks->add( 'wp_enqueue_scripts', 'custom_design_style' );
    $calibrefx->hooks->add( 'wp_enqueue_scripts', 'custom_design_logo' );
    $calibrefx->hooks->add( 'calibrefx_before_save_core', 'custom_design_save_core' );
}
...
function custom_design_logo_settings(){
    ...
    $calibrefx->hooks->add( 'logo-settings_options', function() {            
    ...
    $calibrefx->hooks->add( 'show-header-text-settings_options', function() {            
        calibrefx_add_meta_option(
    ...
    $calibrefx->hooks->add( 'header-text-settings_options', function() {            
        calibrefx_add_meta_option(
    ...
    $calibrefx->hooks->add( 'favicon-settings_options', function() {            
        calibrefx_add_meta_option(
...
function custom_design_background_settings(){
    ...
    $calibrefx->hooks->add( 'background-settings_options', function() {            
        calibrefx_add_meta_option(
